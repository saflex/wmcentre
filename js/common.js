    ...
    $(document).on("submit", '#modalContent form', function(e) {
        ...
        $.ajax({
            ...
            success: function(result) {
                $('#modalContent').html(result).hide().fadeIn();
            }
        });
    });
...
$(document).ready(function() {
    ...
    $(".receive-eps-list .item").click(function() {
        $(".receive-eps-list .item").removeClass('active');
        $(this).addClass('active');
    });

    $(".send-eps-list .item").click(function() {
        $(".send-eps-list .item").removeClass('active');
        $(this).addClass('active');
    });


    $(".langs .item-langs").click(function() {
        $(".langs .item-langs").removeClass('active');
        $(this).addClass('active');
    });
